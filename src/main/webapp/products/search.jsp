...
<body>
    ...
    <div class="wrap hiden-center">
        <div class="center_product " id="product-details">
            <div class="center_product-dentail">
              <form action="<%=urlTop %>/san-pham" method="post" id="productForm" >
                    ...
                    <div class="top-teaMilk-infor">
                            ...
                            <div class="total_price-center">
                                <div class="add-option--now">
                                    <button class="sign hover_button-red" name="product-option" value="add-cart">Thêm vào giỏ hàng</button>
                                </div>
                                <div class="add-option--now">
                                    <button class="sign hover_button-red" name="product-option" value="buy-now">Mua ngay</button>
                                </div>
                            </div>
        ...
        <div class="title_center text_center background_boddy">
            ...
            <div class="show_product">
            	...
            	if (request.getAttribute("searchValue") != null) {
            		nameSearch += request.getAttribute("searchValue");
            	}
                ArrayList<Product> arrSearch = proDAO.selectBySearch(nameSearch);
                %>
               <h3 class="search_result">Kết quả tìm kiếm: <span><%=nameSearch %></span></h3>
                <div class="wrap_show wrap_show-break">
                    <%
                    	if(!arrSearch.isEmpty())
                    	{
        
                		for(Product product : arrSearch){
                        ...
                        <div class="wrap_show-all length_cart">
                            ...
                            <div class="wrap_show-information plus_coversition max_with-store">
                                ...
                                <div class="wrap_show-price flex_cart">
                                    <p class="sync-money"><%=product.getSizeProduct().getSizeM() %></p>
	...
	<jsp:include page="../footer.jsp" />
	    <script src="<%=urlTop %>/js/style.js"></script>
