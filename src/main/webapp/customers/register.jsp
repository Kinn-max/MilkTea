...
<body>
	...
	String email = "";
	String errorMessage ="";
	if (request.getAttribute("notifyUser") != null) {
	    notifyUser += request.getAttribute("notifyUser");
	}else{
		notifyUser +="";
	}
	if (request.getAttribute("notifyEmail") != null) {
		notifyEmail += request.getAttribute("notifyEmail");
	}else{
		notifyEmail +="";
	}
	if (request.getAttribute("notifyPassword") != null) {
		notifyPassword += request.getAttribute("notifyPassword");
	}else{
		notifyPassword +="";
	}
    ...
    <div class="backgroud__sigIn-shop">
        <div class="class__signIn-shopp">
            <video  autoplay loop muted class="sigIn-shop--mp4">
                <source type="video/mp4" asp-append-version="true" src="<%=url %>/mp4/intro_sign_In.mp4" >  
            </video> 
        </div>  
            ...
            <div class="heading__title">
                ...
                <form class="form" action="<%=url %>/customer"  method="post">
                    <div class="input-group inpu_bottom">
                        ...
                        <input class="checkRed" type="text" name="fullname" id="fullname" value="<%=fullName %>">
                        <span class="formEr"></span>
                    </div>
                    <div class="input-group inpu_bottom">
                        <label for="username" class="text_label">Tên đăng nhập</label>
                        <input class="checkRed" type="text" name="username" id="username" value="<%= userName %>">
                        <span class="formEr"><%=notifyUser %></span>
                    </div>
                    <div class="input-group inpu_bottom">
                        <label for="email" class="text_label">Email</label>
                        <input type="text" name="email" id="email" value="<%= email%>">
                        <span class="formEr"><%=notifyEmail %></span>

                    </div>
                    <div class="input-group inpu_bottom">
                        <label for="password" class="text_label">Mật khẩu</label>
                        <input type="password" name="password" id="password" placeholder="">
                        <span class="formEr"></span>
                    </div>
                    <div class="input-group inpu_bottom">
                        <label for="confirm_password" class="text_label">Nhập lại mật khẩu</label>
                        <input type="password" name="confirm_password" id="confirm_password" placeholder="">
                        <span class="formEr"><%=notifyPassword %></span>
                       
                    </div>
                    <button class="sign hover_button-red" name="submit" value="register">Đăng ký</button>
                </form>
                ...
                <p class="signup">
                    <a rel="noopener noreferrer" href="<%=url %>/customers/signIn.jsp" class="" >Sign in</a>
                </p>
            </div>
            <div class="logo__Myshopp">
                
                <div class="logo__Myshopp--img">
                    <img src="<%=url %>/img/the_end.jpg" alt="">
                </div>
                <div class="maxim">
                    ...
                    <p>Ưu đãi mỗi ngày</p>
                    	...
                    	var notifyAmongValue = "<%=errorMessage%>";
