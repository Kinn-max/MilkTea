...
<body>
	<% 
	String notifyTotal = "";
	if (request.getAttribute("notifyTotal") != null) {
		notifyTotal += request.getAttribute("notifyTotal");
	}else{
		notifyTotal +="";
	}
            ...
            <div class="heading__title">
                ...
                <form class="form" action="<%=url %>/customer"  method="post">
                    <div class="input-group inpu_bottom">
                        <label for="username" class="text_label">Tên người dùng</label>
                    ...
                    <button class="sign hover_button-red"  name="submit" value="signIn">Đăng Nhập</button>
                </form>
                ...
                <p class="signup">Don't have an account?
                    <a rel="noopener noreferrer" href="<%=url %>/customers/register.jsp" class="" >Sign up</a>
                </p>
            </div>
            <div class="logo__Myshopp">
                
                <div class="logo__Myshopp--img">
                    <img src="<%=url %>/img/the_end.jpg" alt="connect">
                </div>
                <div class="maxim">
